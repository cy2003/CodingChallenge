...
var message = '<div id="message"><div class="cart-items-number" style="text-align:center; margin-bottom:30px"><span class="total-items" style="font-size:36px; letter-spacing:-0.26px">Your Cart: '+numberOfItems+ '</span></div><div class="box-cart-products"><div class="box-cart-product"><div class="box-cart-product-image" style="postion:relative; float:left; width:35%"><img src="'+itemImages[0]+'"/></div><div class="box-cart-product-name" style="float:right; width:63%"><span>'+itemNames[0]+'</span></div></div><div class="box-cart-product" style="float:left; width:35%"><div class="box-cart-product-image" style="position:relative; float:left; width:35%"><img src="'+itemImages[1]+'"/></div><div class="box-cart-product-name" style="float:right; width:63%"><span>'+itemNames[1]+'</span></div></div></div><div class="order-total"><td>Estimated Total</td><td class="order-value">   '+cartTotal+'</td></div><div><a class="box-cart-link primary-button show-for-large" style="background-color:#cc0001; color:#fff; border:1px solid #cc0001; width:100%; padding:14px 30px; font-size:12px; cursor:pointer" href="https://marmot.com/cart">Go To Cart</a></div></div>'
